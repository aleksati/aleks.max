...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 109.0, 95.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.125000000000455, 211.0, 39.0, 20.0 ],
					"text" : "why?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.125000000000455, 121.0, 132.0, 34.0 ],
					"text" : "max length of world x-dim is 1024px"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 51.125000000000455, 246.512259999999969, 45.0, 22.0 ],
					"text" : "*~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.125000000000455, 265.512259999999969, 85.0, 22.0 ],
					"text" : "s x-dim-value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.625000000000455, 10.740740716457367, 252.0, 34.0 ],
					"text" : "A DSP counter mechanism for precision printing and timing."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 353.125000000000455, 336.512259999999969, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.125000000000455, 302.512259999999969, 78.0, 22.0 ],
					"text" : "sprintf %.2f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.125000000000455, 265.512259999999969, 150.0, 22.0 ],
					"text" : "expr ($f1 / 1024) * $f2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 217.125000000000455, 228.0, 155.0, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.125000000000455, 159.0, 53.0, 22.0 ],
					"text" : "round"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.125000000000455, 187.512259999999969, 100.0, 22.0 ],
					"text" : "loadmess 44100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 484.125000000000455, 232.024519999999939, 140.0, 22.0 ],
					"text" : "expr (5167.9 * 512) / $f1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 426.125000000000455, 187.512259999999969, 77.0, 22.0 ],
					"text" : "adstatus sr"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.125000000000455, 377.512259999999969, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.125000000000455, 79.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 217.125000000000455, 191.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.125000000000455, 127.0, 129.0, 22.0 ],
					"text" : "expr ($f1 * 924) + 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.125000000000455, 393.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 51.125000000000455, 305.0, 143.083333333333599, 22.0 ],
					"text" : "%~ 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 51.125000000000455, 346.0, 85.0, 22.0 ],
					"text" : "snapshot~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 127.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 51.125000000000455, 211.0, 59.0, 22.0 ],
					"text" : "/~ 5167.9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 51.125000000000455, 165.0, 117.0, 22.0 ],
					"text" : "count~ 0 5291929.6"
				}
